...
.export KVAR_BUF_BUFOFS_LAST    := $0258
.exportzp KVAR_BUF_BUFOFS_SIZE = KVAR_BUF_BUFOFS_LAST - KVAR_BUF_BUFOFS + 1
.export KVAR_LAT                := $0259
.export KVAR_LAT_LAST           := $0262
.exportzp KVAR_LAT_SIZE = KVAR_LAT_LAST - KVAR_LAT + 1
.export KVAR_FAT                := $0263
.export KVAR_FAT_LAST           := $026C
.exportzp KVAR_FAT_SIZE = KVAR_FAT_LAST - KVAR_FAT + 1
.export KVAR_SAT                := $026D
.export KVAR_SAT_LAST           := $0276
.exportzp KVAR_SAT_SIZE = KVAR_SAT_LAST - KVAR_SAT + 1
.export KVAR_KEYD               := $0277
.export KVAR_KEYD_LAST          := $0280
.exportzp KVAR_KEYD_SIZE = KVAR_KEYD_LAST - KVAR_KEYD + 1
...
.export KVAR_UNUSED_1           := $02A7
.export KVAR_UNUSED_1_LAST      := $02FF
.exportzp KVAR_UNUSED_1_SIZE = KVAR_UNUSED_1_LAST - KVAR_UNUSED_1 + 1
...
.export KVAR_UNUSED_2      := $0334
.export KVAR_UNUSED_2_LAST := $033B
.exportzp KVAR_UNUSED_2_SIZE = KVAR_UNUSED_2_LAST - KVAR_UNUSED_2 + 1
.export KERNAL_TBUFFR      := $033C
.export KERNAL_TBUFFR_LAST := $03FB
.exportzp KERNAL_TBUFFR_SIZE = KERNAL_TBUFFR_LAST - KERNAL_TBUFFR + 1
.export KVAR_UNUSED_3      := $03FC
.export KVAR_UNUSED_3_LAST := $03FF
.exportzp KVAR_UNUSED_3_SIZE = KVAR_UNUSED_3_LAST - KVAR_UNUSED_3 + 1
